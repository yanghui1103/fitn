...
<script type="text/javascript" src="<%=basePath %>common/zTree/js/jquery.ztree.core-3.0.js"></script>
<style type="text/css">
.container {
	min-height:380px;
	min-width:50%;
...
<script type="text/javascript" src="<%=basePath %>common/fit/orgStructure.js"></script>
</head>
<body>
	<div class="container">
		<div class="left_c">
